    ...
    <div className={styles.whiteCard}>
          ...
          <div className={styles.checkboxContainer}>
            <div className={styles.checkBoxPadding}>
              <div className={radioStyles}>
                <input
                  className={styles.tabTwoCheckbox}
                  type="checkbox"
                  checked={props.checkedMomentLocale}
                  onChange={props.handleChangeCheckboxMomentLocale}
                />
                <div className={radioStylesState}>
                  <label>MomentLocale </label>
                  <br />
                </div>
              </div>
            </div>
      ...
      {props.isCustomConfigSaved && (
        <div className={styles.tabThreeRowFlexContainer}>
          ...
          <div id={styles.webpackConfigSaveText}>webpack.config.js saved</div>
        </div>
      )}
    </div>
  );
